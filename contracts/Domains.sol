...
contract Domains is ERC721URIStorage {
    ...
    constructor(string memory _tld) payable ERC721("Trader Name Service", "TNS") {
    ...
    function register(string calldata _name) public payable {
        // checks that the name is unnregistered
        ...
        // combine name and tld
        string memory _nameTld = string(abi.encodePacked(_name, ".", tld));

        // svg for nft
        string memory finalSvg = string(abi.encodePacked(svgPartOne, _nameTld, svgPartTwo));
